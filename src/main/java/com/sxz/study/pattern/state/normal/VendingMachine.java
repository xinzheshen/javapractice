package com.sxz.study.pattern.state.normal;
...
public class VendingMachine {
    ...
    public void backMoney() {
        switch (currentStatus) {
            case NO_MONEY://未投币
                System.out.println("backMoney---您未投入硬币");
                break;
            case HAS_MONEY://已投币
                currentStatus = NO_MONEY;
                ...
                break;
            case SOLD://售出商品
                System.out.println("backMoney---您已经买了糖果...");
                break;
            case SOLD_OUT://商品售罄
                System.out.println("backMoney---您未投币,想坑我钱吗?");
                break;
        }
    }
    ...
    public void turnCrank() {
        switch (currentStatus) {
            case NO_MONEY://未投币
                System.out.println("turnCrank---请先投入硬币");
                break;
            case HAS_MONEY://已投币
