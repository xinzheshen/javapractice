package com.sxz.study.pattern.strategy.better.base;
...
public abstract class Role {
    ...
    public Role setDefendBehavior(IDefendBehavior iDefendBehavior) {
        this.iDefendBehavior = iDefendBehavior;
        return this;
    }

    public Role setRunBehavior(IRunBehavior iRunBehavior) {
